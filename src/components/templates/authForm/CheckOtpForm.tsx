...
import { TCheckOtpProps } from "@/core/types/props";
...
function CheckOtpForm({ mobile, closeModal, setStep }: TCheckOtpProps) {
  const [code, setCode] = useState<string>("");
  const [counter, setCounter] = useState<number>(85);
  const [doShake, setDoShake] = useState<number>(0);
