...
import { TTourDetails } from "@/core/types/props";
...
import { TFeaturesDetails } from "@/core/types/fetchData";

function TourDetailsPage({ data }: TTourDetails) {
  if (data?.message) return <ErrorOnClient message={data.message} />;
  ...
  return (
    <>
      ...
      <div className="md:flex flex-col flex-grow items-center hidden">
        ...
        <p className="text-sm lg:text-base font-medium text-[#282828] font-vazir mt-1">
          {startDate && getPersianDate(startDate)}
        </p>
      </div>
      <span className="hidden md:block h-full border-l border-l-[#00000040]"></span>
      <div className="md:flex flex-col flex-grow items-center hidden">
        ...
        <p className="text-sm lg:text-base font-medium text-[#282828] font-vazir mt-1">
          {endDate && getPersianDate(endDate)}
        </p>
      </div>
      <span className="hidden md:block h-full border-l border-l-[#00000040]"></span>
