...
import { TQuery, TSearchFormProps } from "@/core/types/props";
import CustomDatePicker from "@/components/atoms/CustomDatePicker";

function SearchForm({ data }:TSearchFormProps) {
  ...
  const searchHandler = (e:any) => {
    ...
    const newQuery: any = { ...rest };

    if (originInfo) newQuery.originId = originInfo.id;
    if (destinationInfo) newQuery.destinationId = destinationInfo.id;
